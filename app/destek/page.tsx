          ...
          <section id="iletisim" className="scroll-mt-20">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-3xl">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-white"><Mail className="text-amber-500" size={20}/> <b>E-Posta:</b> destek@koncasaas.com</div>
                <div className="flex items-center gap-3 text-white"><MapPin className="text-amber-500" size={20}/> <b>Merkez:</b> Teknopark, İstanbul / Türkiye</div>
              </div>
